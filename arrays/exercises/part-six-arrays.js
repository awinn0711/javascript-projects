...
console.log(table[2][2]);
    //Using only one index prints the entire outer array at that index (the 'row' of the table). using two indices prints the item at the specified row and column
...
let threeDimenArray = [];
threeDimenArray.push(tableTwo,tableThree);
console.log(threeDimenArray);
console.log(threeDimenArray[0]);
console.log(threeDimenArray[1][0]);
console.log(threeDimenArray[0][1][0]);
